...
part of 'DbDataSource.dart';

// **************************************************************************
// FloorGenerator
// **************************************************************************

class $FloorDbDataSource {
  /// Creates a database builder for a persistent database.
  /// Once a database is built, you should keep a reference to it and re-use it.
  static _$DbDataSourceBuilder databaseBuilder(String name) =>
      _$DbDataSourceBuilder(name);

  /// Creates a database builder for an in memory database.
  /// Information stored in an in memory database disappears when the process is killed.
  /// Once a database is built, you should keep a reference to it and re-use it.
  static _$DbDataSourceBuilder inMemoryDatabaseBuilder() =>
      _$DbDataSourceBuilder(null);
}

class _$DbDataSourceBuilder {
  _$DbDataSourceBuilder(this.name);
  ...
  _$DbDataSourceBuilder addMigrations(List<Migration> migrations) {
    _migrations.addAll(migrations);
    return this;
  }

  /// Adds a database [Callback] to the builder.
  _$DbDataSourceBuilder addCallback(Callback callback) {
    _callback = callback;
    return this;
  }

  /// Creates the database and initializes it.
  Future<DbDataSource> build() async {
    final path = name != null
        ? await sqfliteDatabaseFactory.getDatabasePath(name!)
        : ':memory:';
    final database = _$DbDataSource();
...
class _$DbDataSource extends DbDataSource {
  _$DbDataSource([StreamController<String>? listener]) {
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ContactsModel` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT NOT NULL, `phoneNumber` TEXT NOT NULL, `email` TEXT NOT NULL)');
        await database.execute(
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `CallHistoryModel` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `contacts_id` INTEGER NOT NULL, `dateTime` TEXT NOT NULL)');
...
class _$ContactsDao extends ContactsDao {
  ...
  Future<List<ContactsModel>> getAllContacts() async {
    return _queryAdapter.queryList('SELECT * FROM ContactsModel',
  ...
  Future<List<ContactsModel?>> searchContacts(String name) async {
    return _queryAdapter.queryList('SELECT * FROM ContactsModel WHERE name = ?',
        arguments: [name],
        mapper: (Map<String, Object?> row) => ContactsModel(
            row['id'] as int?,
            row['name'] as String,
  ...
  Future<void> deleteContact(String id) async {
    await _queryAdapter.queryNoReturn(
        'DELETE * FROM ContactsModel WHERE id = ?',
        arguments: [id]);
  }
...
class _$CallLogsDao extends CallLogsDao {
  ...
  Future<List<CallHistoryModel>> getAllMessages() async {
    return _queryAdapter.queryList('SELECT * FROM CallHistoryModel',
        mapper: (Map<String, Object?> row) => CallHistoryModel(
            row['id'] as int?,
            row['contacts_id'] as int,
  ...
  Future<void> deleteHistory(int id) async {
    await _queryAdapter.queryNoReturn(
        'DELETE * FROM CallHistoryModel WHERE id = ?',
        arguments: [id]);
  }
...
class _$MessagesDao extends MessagesDao {
  ...
  Future<List<MessagesModel>> getMessagesByConversationId(int id) async {
    return _queryAdapter.queryList(
        'SELECT * FROM MessagesModel WHERE conversationId = ?',
        arguments: [id],
...
class _$ConversationDao extends ConversationDao {
  ...
  Future<List<ConversationModel>> getAllConversations() async {
    return _queryAdapter.queryList('SELECT * FROM ConversationModel',
  ...
  Future<ConversationModel?> deleteConversationById(int conversationId) async {
    return _queryAdapter.query('DELETE * FROM ConversationModel WHERE id = ?',
