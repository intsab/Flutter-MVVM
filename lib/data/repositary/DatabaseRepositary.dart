...
import 'package:private_communication/data/datasource/DbDataSource.dart';

class DatabaseRepositary {
  final String dbName = 'private_planet.db';

  void insertContact(ContactsModel contact) async {
    final database = await $FloorDbDataSource.databaseBuilder(dbName).build();
